package com.geekbrains.kotlinfirstapp.ui.customviews
...
import com.geekbrains.kotlinfirstapp.data.common.dip
import com.geekbrains.kotlinfirstapp.data.common.getColorRes
...
class ColorPickerView : LinearLayout {
    ...
    private val updateListener by lazy {
        ValueAnimator.AnimatorUpdateListener { animation ->
            layoutParams.apply {
                height = animation.getAnimatedValue(HEIGHT) as Int
            }.let {
                layoutParams = it
            }

            val scaleFactor = animation.getAnimatedValue(SCALE) as Float
    ...
    fun open(){
        animator.cancel()
        animator.setValues(PropertyValuesHolder.ofInt(HEIGHT,measuredHeight,desireHeight),
